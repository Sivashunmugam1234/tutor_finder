...
const TeacherCard = ({ teacher }) => {
    ...
    const hasCustomImage = teacher.profilePicture && teacher.profilePicture !== defaultIcon;
            ...
            <div className="relative w-24 h-24 mx-auto mb-4">
                ...
                {hasCustomImage && (
                    <img 
                        ...
                        alt={teacher.name} 
                        className="w-24 h-24 rounded-full absolute inset-0 opacity-0 transition-opacity duration-300" 
